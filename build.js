...
const files=['index.html','privacy.html','styles.css','lessons.css','lingala.css','achievements.css','kingdoms.css','presidency.css','heroes.css','communities.css','food.css','environment.css','resources.css','creativity.css','sprint.css','profile.css','memory.css','i18n.css','teacher.css','provinces.css','map.css','levels.css','audio.css','daily.css','pwa.css','hardening.css','pilot.css','math.css','music-game.css','app.js','content-en.js','i18n.js','math.js','music-game.js','pwa.js','sw.js','manifest.webmanifest','icon.svg','okapi.jpg'];
